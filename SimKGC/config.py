...
parser.add_argument('--rotate-path', default='data/WN18RR/RotatE_200/', type=str, metavar='N',
                    help='path to RotatE, only used for evaluation')

args = parser.parse_args()

assert not args.train_path or os.path.exists(args.train_path)
assert args.pooling in ['cls', 'mean', 'max']
assert args.task.lower() in ['wn18rr', 'fb15k237', 'wiki5m_ind', 'wiki5m_trans', 'umls', 'kinship', 'codexm', 'yago3-10']
